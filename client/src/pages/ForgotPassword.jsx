...
import { ForgotPasswordRequest } from '../apiCalls/ForgotPasswordRequest'
...
const ForgotPassword = () => {
    ...
    const [notExist, setNotExist] = useState('none')
  ...
  return (
    ...
    <div className='account'>
         <div className='alertBox' style={{display:alertBox}}>
            <div className="box">
                <div className="subHeading font1 mb-2" style={{color:'gray'}}>Password Changed</div>
                <div className="font1 mb-3">Please login with your email id and new password to continue</div>
                <Link to='/login' className="btn btn-danger me-1">Login</Link>
                <Link to='/' className="btn btn-primary me-1">Cancel</Link>
            </div>
        </div>
        <div className="accountCard">
            {emailSection &&
                <>
                    ...
                    <div className="font1 text-danger text-center mb-3" style={{display:notExist}}>
                        Sorry, this email is not rgistered on our website.Please signup to continue with this email.
                    </div>
            ...
            {passwordSection &&
                ...
                <div className="font1">Enter email</div>
                ...
                <div className="box">
                    <div className="font1">Enter New Password</div>
                    <div className="inputBox">
                ...
                <div className="btn bgColor w-100" style={{color:'white'}} onClick={changePassword}>Change Password</div>
                </>
            }
        </div>
    </div>
